...
**Post-release corrections completed locally:** The bounded R4/R6 set-page hierarchy correction is independently reviewed at `a640529`; the species hierarchy and shared regional inventory-anchor correction are tested and independently reviewed at `b15d792`. Before/after galleries: `../shots/set-hierarchy/index.html` and `../shots/species-hierarchy/index.html`. These changes are NOT deployed and do not reopen or replace the original roadmap. The earlier release remains live; the owner-feedback instruction explicitly prohibits deployment.
