...
**Post-release corrections completed locally:** Set hierarchy is independently reviewed at `a640529`, species hierarchy/shared inventory-anchor behavior at `b15d792`, and the directory/release/sealed shopping continuation at `5800891` plus `3fd49eb`. Galleries: `../shots/set-hierarchy/index.html`, `../shots/species-hierarchy/index.html`, `../shots/browse-journey/index.html`. These changes are NOT deployed. The owner's expanded page-template request now continues with the remaining search front door under provider isolation; this does not reopen the original roadmap or authorize deployment.
