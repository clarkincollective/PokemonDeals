...
Still outstanding after this review: 320/390px and keyboard verification for the three earlier-fixed items (homepage copy, catalogue/search savings gating, DealCard CTA wording); Safari/WebKit verification for all four fixed items; a decision on the newsletter copy vs. digest activation. Nothing in this branch has been pushed; production remains `9605652`.
