...
**Post-release correction ready for owner review:** The bounded R4/R6 set-page hierarchy correction is implemented, tested and independently reviewed at `a640529`. Before/after gallery: `../shots/set-hierarchy/index.html`. These changes are NOT deployed and do not reopen or replace the original roadmap. The earlier release remains live; this new instruction explicitly prohibits deployment.
