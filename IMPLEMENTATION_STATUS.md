...
**Active post-release correction:** Owner-reported set-page hierarchy feedback is being handled as a bounded R4/R6 acceptance follow-up below. Its local changes are NOT deployed and do not reopen or replace the original roadmap. The earlier release remains live; this new instruction explicitly prohibits deployment.
