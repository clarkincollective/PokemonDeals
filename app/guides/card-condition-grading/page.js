...
export default function Page() {
  return (
    <GuideLayout slug={SLUG}>
      ...
      <GP>
        This wording is marketplace vocabulary, not a single agreed standard: different venues
        describe raw cards in different ways. The reference prices behind this site come from
        TCGPlayer, and the condition labels our catalogue carries are TCGPlayer&apos;s &mdash; in
        practice &ldquo;Near Mint&rdquo; and, rarely, &ldquo;Lightly Played&rdquo;. The one-line
        descriptions below are our own plain-language explanations of the terms; they are not taken
        from any company&apos;s published condition standard, so check the standard that applies
        wherever you are buying. Whichever wording a listing uses, a raw card&apos;s condition is
        assigned by the seller, so treat it as a claim to verify against the photos, not a fact.
      </GP>
      <GUL>
        <li>
      ...
      <GP>
        Keep these labels separate from numeric grades. A seller&apos;s raw-condition label does not
        guarantee a third-party grade. Grading companies assess cards under their own published
        standards, on the exact copy in front of them, which is not the same exercise as a seller
        describing a card in a listing.
      </GP>
