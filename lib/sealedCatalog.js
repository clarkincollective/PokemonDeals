...
const TYPE_RULES = [
  ...
  ["Tin", /\btin\b/i],
  ["Collection Box", /collection|premium collection|special collection|v-?union|ex box|figure box|poster collection|binder/i],
...
module.exports = { sealedProductType, SEALED_PRODUCT_TYPES, sealedCatalogRecord };
