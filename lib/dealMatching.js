...
// clearly says PSA/CGC/BGS/etc. Same six graders the rest of the site
// recognises; not a second grade classifier.
const GRADER_MENTION_PATTERN = /\b(psa|cgc|bgs|beckett|sgc|ace|tag)\b/i;
