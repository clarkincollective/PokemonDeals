...
//       ask a human".
export async function submitBufferPlacementLive(placement, pkg, { env = process.env, provider = null, db = realDb } = {}) {
  ...
  const msg = {
    ...
    text: caption, assets: placement.artifact_hash ? [] : [], // §7 - asset URL wiring is a hosting concern outside this phase's scope; see report
