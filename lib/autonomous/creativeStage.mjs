...
export async function resolveCreative(pkg, {
  ...
  }, { imageBufferOrPath: Buffer.from(r.image_b64 ?? r.b64 ?? "", "base64") });
  return { ok: true, creative: stored, semanticManifest, factLock, source: "generated", costUsd: r.cost_usd ?? 0.45 };
}
