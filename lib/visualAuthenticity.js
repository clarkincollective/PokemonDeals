...
function visionPrompt(card) {
  return (
    ...
    `WOTC-era printings (Base Set, Jungle, Fossil and the other 1999-2000 sets) share\n` +
    `their name, number, HP, attacks, artwork and copyright line across print runs, so\n` +
    `those matching does NOT establish MATCH. Two markers separate the printings and are\n` +
    `part of the printing, never wear or lighting:\n` +
    `  - a "1st Edition" stamp (a small black stamp below the left of the illustration)\n` +
    `  - the drop shadow along the right and bottom of the illustration frame\n` +
    `    (present on Unlimited, absent on Shadowless and 1st Edition)\n` +
    `Image 1 is the Unlimited printing unless its set name says otherwise. If image 2\n` +
    `carries a 1st Edition stamp that image 1 does not, or lacks a drop shadow that\n` +
    `image 1 has, answer IDENTITY_MISMATCH - it is a genuine card of a DIFFERENT and\n` +
    `differently-priced printing - even when everything else on the card agrees.\n` +
