...
async function fetchSetCatalogUncached(setName, language = "english") {
  if (!setName) return { cards: [], dealCount: 0, totalCards: 0, truncated: false, stats: null, indexable: false, priceSnapshot: null, speciesList: [], topValueCards: [], error: null };
  ...
  if (catErr && !/card_catalog/.test(catErr.message || "")) {
    return { cards: [], dealCount: 0, totalCards: 0, truncated: false, stats: null, indexable: false, priceSnapshot: null, speciesList: [], topValueCards: [], error: catErr.message };
  }
