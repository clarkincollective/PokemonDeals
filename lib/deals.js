...
import { isDisplayableDeal, isPremiumDealEligible, isExactEbayDealDestination, auctionEnded } from "@/lib/dealQuality";
...
async function fetchBestFindsUncached({
  ...
  // smaller curated pool independently. PREMIUM gate: also drops a
  // high-risk raw card that has no completed MATCH visual verdict.
  const seen = new Set();
  const deals = [];
