...
export const fetchCardOffers = unstable_cache(fetchCardOffersUncached, ["card-offers-v2"], {
  revalidate: POOL_REVALIDATE_SECONDS,
});
...
export const fetchCardDealsPage = unstable_cache(fetchCardDealsPageUncached, ["card-deals-page"], {
  revalidate: POOL_REVALIDATE_SECONDS,
});
