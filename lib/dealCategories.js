...
const DEAL_CATEGORIES = {
  ...
  modern: {
    ...
    description:
      "Below-market deals on modern Pokemon cards: Sword & Shield, Scarlet & Violet, Mega Evolution and newer releases, checked against real PokemonPriceTracker market pricing.",
    intro:
      "Live below-market eBay listings for cards from recent sets: Sword & Shield, Scarlet & Violet, Mega Evolution and newer releases. The set list updates automatically as new sets release.",
  },
