...
const DEAL_CATEGORIES = {
  ...
  modern: {
    ...
    // 65-char title cap: the three era names ran to 76. Naming the range's
    // endpoints keeps the same span and intent - the intro and description
    // below still list every era in full.
    title: "Modern Pokemon Card Deals — Sword & Shield to Mega Evolution",
    description:
  ...
  uk: {
    ...
    title: "UK Pokemon Card Deals — eBay.co.uk Listings Below Market (GBP)",
    description:
      "Browse tracked eBay.co.uk Pokemon card listings priced below their market reference, listed in pounds. Every listing is condition-checked and re-verified before it is shown.",
    intro:
      "Tracked eBay.co.uk listings for Pokemon cards, priced in GBP, sorted newest first. Each one is compared with a recent-sold market reference for the exact card and condition; use the filters for raw or graded, price or auctions.",
  },
  australia: {
    filter: { country: "EBAY_AU" },
    h1: "Pokemon Card Deals in Australia",
    // 65-char title cap: 71 with "Listings". Dropping that one filler word
    // keeps the marketplace, the currency and the below-market intent.
    title: "Australian Pokemon Card Deals — eBay.com.au Below Market (AUD)",
    description:
      "Browse tracked eBay.com.au Pokemon card listings priced below their market reference, listed in Australian dollars. Condition-checked and re-verified before they are shown.",
    intro:
      "Tracked eBay.com.au listings for Pokemon cards, priced in AUD, sorted newest first. Each one is compared with a recent-sold market reference for the exact card and condition; use the filters for raw or graded, price or auctions.",
  },
  canada: {
    filter: { country: "EBAY_CA" },
    h1: "Pokemon Card Deals in Canada",
    title: "Canadian Pokemon Card Deals — eBay.ca Listings Below Market (CAD)",
    description:
      "Browse tracked eBay.ca Pokemon card listings priced below their market reference, listed in Canadian dollars. Condition-checked and re-verified before they are shown.",
    intro:
      "Tracked eBay.ca listings for Pokemon cards, priced in CAD, sorted newest first. Each one is compared with a recent-sold market reference for the exact card and condition; use the filters for raw or graded, price or auctions.",
  },
  usa: {
    filter: { country: "EBAY_US" },
    h1: "Pokemon Card Deals in the US",
    title: "US Pokemon Card Deals — eBay.com Listings Below Market (USD)",
    description:
      "Browse tracked eBay.com Pokemon card listings priced below their market reference, in US dollars. Condition-checked and re-verified before they are shown.",
    intro:
      "Tracked eBay.com listings for Pokemon cards, priced in USD, sorted newest first. Each one is compared with a recent-sold market reference for the exact card and condition; use the filters for raw or graded, price or auctions.",
  },
