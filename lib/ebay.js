...
// filter dropdown in app/page.js.
const MARKETPLACES = {
  EBAY_US: { label: "United States", flag: "🇺🇸" },
  EBAY_GB: { label: "United Kingdom", flag: "🇬🇧" },
  EBAY_AU: { label: "Australia", flag: "🇦🇺" },
  EBAY_CA: { label: "Canada", flag: "🇨🇦" },
  EBAY_DE: { label: "Germany", flag: "🇩🇪" },
};
...
// per listing.
async function searchListings(query, marketplaceId, { limit = 20 } = {}) {
