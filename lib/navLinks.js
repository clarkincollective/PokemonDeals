...
export const NAV_PRIMARY = [
  ...
  // listings are eligible to show for them. `analyticsClick` /
  // `analyticsProps` are emitted by BOTH renderers (desktop bar + mobile
  // menu), so the entry is measurable wherever it is shown.
  {
  ...
  // Editorial entry point. Guides and the market-data research were only
  // reachable two levels down ("Learn > Guides", "Browse > Market Data"),
  // which is where readers lost them. One top-level entry, landing on
  // /guides, which now carries both the guides and a Research section.
  // PRIMARY (not a dropdown item) because only this renderer pair emits
  // analyticsClick/analyticsProps - NavDropdown has no per-item markers.
  {
    href: "/guides",
...
export const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      // "Guides" moved up to NAV_PRIMARY as "Guides & Research" - keeping a
      // second copy here would split the same destination across two menus.
      { href: "/#faq", label: "FAQ" },
    ],
  },
];
