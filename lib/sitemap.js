...
const STATIC_ROUTES = [
  ...
  // Another FIXED, DATED study: figures describe 2026-08-26 to 2026-09-20
  // and are not refreshed, so no <lastmod> for the same reason as below.
  {
    loc: `${SITE_URL}/market-data/how-long-pokemon-deals-last`,
    changefreq: "yearly",
    priority: 0.6,
  },
  {
