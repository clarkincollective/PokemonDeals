...
export async function resolveSearchIntent(intent, { lookup }) {
  ...
  // number subject is claimed by rules 1-5 above (and rule 6's own
  // `wantName` gate is the mirror image of this one), so this can never
  // steal `base set charizard` or `base set charizard 4/102`.
