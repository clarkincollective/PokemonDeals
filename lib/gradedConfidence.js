...
// Set / name patterns that also indicate a reused identity (reprint
// packs, promo re-releases, prerelease/staff variants, jumbos).
const SHARED_IDENTITY_RE =
  /base set 2|legendary collection|celebration|classic collection|xy - evolutions|first partner|prize pack|trick or trade|jumbo|deck exclusive|prerelease|\bstaff\b|world championship|winner\b/i;
