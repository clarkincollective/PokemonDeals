...
export const GUIDES = [
  ...
  // those need data this site does not hold.
  {
    ...
    blurb:
      "Four buying routes into Scarlet & Violet 151 and who each one suits: one exact card, sealed packs, a boxed product, or a checklist to work through. Includes the two different 151 Elite Trainer Boxes.",
  ...
  },
  {
    ...
    blurb:
      "What each sealed format actually contains, which buyer each one suits, and why 'an ETB' is not one product - one set in our catalogue has three different Elite Trainer Boxes.",
    published: "2026-09-22",
    updated: "2026-09-22",
  },
  {
  ...
  },
  {
    ...
    blurb:
      "How the two release lines differ in set structure, numbering and product format, why one English set can draw on several Japanese ones, and what that means when you are reading a listing.",
    published: "2026-09-22",
    updated: "2026-09-22",
  },
  {
  ...
  },
  {
    ...
    title: "Holo vs Reverse Holo Pokemon Cards: What to Check",
    shortTitle: "Holo vs reverse holo",
    blurb:
      "Where the foil sits on each, why one collector number can cover several different cards, and how to make a listing tell you which printing it is before you buy.",
    published: "2026-09-22",
    updated: "2026-09-22",
  },
  {
