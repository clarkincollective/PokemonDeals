...
// Set page (/sets/[slug]): at least one active deal in the set. Enforced
// implicitly - fetchSets only ever lists a set that produced a row, so
// count is always >= 1. Kept named for the docs and in case the bar ever
// rises.
export const SET_MIN_LISTINGS = 1;
