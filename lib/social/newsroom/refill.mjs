...
// SS3 - the prepared cadence. cron_hint is 20:00 UTC Sun+Wed = 06:00
// Australia/Brisbane (UTC+10, no DST) - a sensible pre-business editorial
// planning window. NOT added to vercel.json until proof (SS30).
export const REFILL_SCHEDULE = Object.freeze({
  days: ["sunday", "wednesday"],
  cron_hint: "0 20 * * 0,3",
  cron_utc: "20:00 UTC Sun + Wed",
  brisbane_local: "06:00 Australia/Brisbane Sun + Wed (UTC+10, no DST)",
  activated: false,
});
