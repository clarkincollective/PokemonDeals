...
export const QA_LAYERS = Object.freeze(["FACT", "RIGHTS_IMAGE", "CREATIVE", "ORIGINALITY_SEQUENCE", "VISUAL_REVIEW"]);
...
export function creativeLayer(meta = {}) {
  const qa = scoreCreative(meta); // { grade:'PASS'|'WATCH'|'FAIL', score, checks, family }
