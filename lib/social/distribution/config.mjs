...
// --- EPN account / campaign review (FACTUAL RECORD — NOT a gate) -------
//
// 2026-09: eBay Partner Network Operations Support / Quality Team
// confirmed IN WRITING: "We have completed our review and do not require
// any additional information or action from you." They also stated our
// campaigns were brought "in compliance."
//
// This records the outcome of that ACCOUNT / CAMPAIGN review ONLY. It is
// explicitly NOT:
//   - an approval of AI-generated social content,
//   - an approval of OpenAI / any GenAI usage,
//   - a blanket approval of every future implementation.
//
// The GenAI pipeline's compliance posture is UNCHANGED and is still
// governed solely by SOCIAL_EPN_AI_CLASSIFICATION (above), which stays
// NOT_APPLICABLE_CURRENT_PIPELINE for the current data-free architecture.
//
// Nothing here reads the environment, and NOTHING in gates.mjs or any
// publishing preflight references these constants — they add no gate and
// remove none. Documentation: docs/social-compliance-readiness.md §4b.
export const EPN_ACCOUNT_REVIEW = "CLOSED_COMPLIANT";
export const EPN_ACCOUNT_REVIEW_ACTION_REQUIRED = false;
