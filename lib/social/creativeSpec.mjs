...
// Exported so the 13E.10A experiment layer shares the EXACT eligibility
// thresholds (never a parallel, drifting copy).
export const PRICE_CONTRAST_MIN_REF = 100;   // the "$X CARD" figure must be worth saying
export const PRICE_CONTRAST_MIN_RATIO = 1.8; // reference / listed
export const ABS_SAVING_MIN = 60;            // $ gap worth leading with
