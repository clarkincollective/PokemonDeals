...
// --- Phase 5A: the ruthless semantic auditor + brand lock ---
export {
  buildSemanticManifest, comparisonDirection, recomputeDerivedFacts, STORY_PREMISES, DIRECTION_WORDS, SEMANTIC_MANIFEST_VERSION,
} from "./semanticManifest.mjs";
export {
  extractImageClaims, auditSemantics, semanticVerify, detectGeneratedBrandRisk, SEMANTIC_AUDIT_VERSION,
} from "./semanticAudit.mjs";
export { provePrintingPair, verifyCardPair, PRINTING_IDENTITY_VERSION } from "./printingIdentity.mjs";
export {
  compositeBrandAssetHtml, BRAND_SAFE_ZONE_CLAUSE, BRAND_SAFE_ZONE_TOP_PX, APPROVED_BRAND, BRAND_MARK_SVG, BRAND_LOCK_VERSION,
} from "./brandLock.mjs";
// --- Phase 5A.1: fact-source locks + auditors ---
export {
  FACT_SOURCE_CLASSES, CARD_METADATA_FIELDS, FACT_SOURCE_VERSION,
...
export { DATA_DISCIPLINE_CLAUSE } from "./fullGenerative.mjs";
