...
export async function renderCardForwardStory(story, platform, { renderer, db, renderDir, sha256, env = process.env } = {}) {
  ...
  const html = renderCardEditorialHtml(spec.layout, { ...facts.props, target, cardArt: art.map });
