...
export function buildUniversalCtaEndScreen({
  ...
  const endScreen = {
    ...
    primary_cta: { ...(variant.line1 ? variant : CTA_UNIVERSAL_FALLBACK), tone: "near_white" },
    ...
    // 4C.6 §16/§17 - the CTA is the brightest, most confident moment; the
    // headline is near-white with a red keyline, the URL field is a bright
    // white panel. It must not read as the video fading away.
    brightness: "high",
    cta_darker_than_story: false,
