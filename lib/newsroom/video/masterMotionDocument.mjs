 ...
 *  -> { html, total }
 */
export function buildMasterMotionDocument({ masterB64, masterMime = "image/png", choreography, layers, ctaText = null, brandInMaster = false }) {
  ...
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  ${capKf.join("\n")}
    ...
    ${caps.join("\n")}
    ${brandInMaster ? "" : `<div class="brand">${mark(30)}<span class="wm"><b>Pokemon</b> Deal Finder</span></div>
