...
export async function renderMasterLayeredMotionToMp4(result, outPath, { posterPath = null, keepFrames = null } = {}) {
  ...
  const doc = buildMasterMotionDocument({ masterB64, masterMime: "image/png", choreography: result.choreography, layers: result.layers, ctaText: result.caption_link ? null : "See the live deal" });
