...
// --- Phase 4C.4: PROFESSIONAL_SOCIAL_LOOP (the NEW preferred production mode) ---
export {
  VIDEO_SAFE_DERIVATIVE_VERSION, VS_W, VS_H, VS_SAFE, VS_STYLE, VS_MIN_FONT,
  centreSafe, buildVideoSafeDerivative,
} from "./videoSafeDerivative.mjs";
export {
  UNIVERSAL_CTA_END_SCREEN_VERSION, CTA_DOMAIN, CTA_VALUE_POINTS, CTA_VARIANTS,
  CTA_UNIVERSAL_FALLBACK, CTA_END_SCREEN_DEFAULT_MS, CTA_END_SCREEN_MIN_MS, CTA_END_SCREEN_MAX_MS,
...
export {
  PROFESSIONAL_VIDEO_QA_VERSION, MOTION_SALIENCE,
...
export {
  ...
  FAMILY_DURATION_MS, buildProfessionalTimeline, runProfessionalSocialLoop, renderProfessionalSocialLoopToMp4,
