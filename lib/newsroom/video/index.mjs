...
export {
  VIDEO_SAFE_DERIVATIVE_VERSION, VS_W, VS_H, VS_SAFE, VS_STYLE, VS_MIN_FONT, CARD_SCALE, FRAME_DENSITY_BANDS,
...
export {
  ...
  PARITY_MIN_OVERALL, PARITY_MIN_DIMENSION, OCCUPANCY_MIN, CARD_PROMINENCE_MIN, LOWER_DEAD_SPACE_MAX, STATIC_MASTER_REFERENCE_SCORE,
  ...
  auditStaticMasterParity, auditMobileHierarchy, scoreOwnerTaste,
  auditContentOccupancy, auditCardProminence, auditLowerDeadSpace, auditCtaLuminance, staticParityRubric,
