...
export function registerExistingMaster({
  ...
  cardMetadataLock = null, captionHandoff = null, verification = {}, source = "approved_artifact", dir = null,
} = {}) {
  return putMasterCreative(
    {
      ...
      card_metadata_lock: cardMetadataLock, caption_handoff: captionHandoff,
