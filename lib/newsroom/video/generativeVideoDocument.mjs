...
export function buildGenerativeVideoDocument({ plan, boardImages = [], motionPlan = [], ctaText = null }) {
  ...
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  .board{position:absolute;inset:0;opacity:0;will-change:transform,opacity,clip-path;overflow:hidden;background:${BRAND.bg};display:flex;align-items:center;justify-content:center}
  /* the generated board is 2:3; the frame is 9:16. Fit to WIDTH so NOTHING
     is cropped horizontally (the image model is weak at keeping side
     margins) - a thin dark band above/below carries the brand chip + domain. */
