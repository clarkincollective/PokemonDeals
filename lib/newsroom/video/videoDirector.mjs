...
function narrationFor({ family, F, sceneTexts }) {
  ...
  if (family === "deal_hero") {
    ...
    lines.push(`${F.claim_value} percent of tracked Pokemon singles have a market price under twenty-five dollars.`);
...
function planMarketShape(F) {
  ...
  const scenes = [
    scene({ purpose: "hook", from: 0, to: 1800, visual: "the headline percentage snaps in, huge", motion: "typographic_emphasis",
      text: t2(`${F.claim_value}% of tracked singles`, "have a market price under $25"), dataRefs: ["claim_value"], transitionOut: "mask_reveal" }),
