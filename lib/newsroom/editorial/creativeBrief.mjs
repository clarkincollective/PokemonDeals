...
export const BRIEF_SCHEMA = Object.freeze({
  ...
  why_it_matters: { kind: "d", required: true, max_words: 30 },
...
export function buildCreativeBrief({ story, platform, factLock, contract = null, layoutFamily = null } = {}) {
  ...
  const brief = {
    ...
    why_it_matters: capWords(c.meaningful, 30),
...
// First `maxWords` words of a sentence, trailing punctuation tidied.
function capWords(sentence, maxWords) {
