...
function isDisplayableDeal(row) {
  ...
  // Every deal (graded included): it must actually be a trading card, the
  // CTA must open the exact listing we priced, the listing must still
  // match the catalogue card, and an ended auction is not live.
