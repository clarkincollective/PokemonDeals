...
function listingPresentation(row, now = Date.now()) {
  const savings = savingsClaimTrusted(row, now) ? "trusted" : null;
  ...
  if (!savings) notes.push("No verified market reference for this exact product and condition yet - shown without a savings claim.");
