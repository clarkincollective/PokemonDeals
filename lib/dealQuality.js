...
const { detectListingCondition, worseCondition, listingMatchesCard } = require("./dealMatching");
...
function isDisplayableDeal(row) {
  ...
  // priced, the listing must still match the catalogue card, and an ended
  // auction is not live.
