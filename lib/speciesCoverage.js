...
// The pilot. Dragonite: the Pokemon page with the most Search Console
// impressions (22 of 32 in 2026-08-12..09-10), 75 catalogue cards in 39
// sets, every card numbered and rarity-labelled.
export const SPECIES_PILOT = Object.freeze(["Dragonite"]);
...
export function speciesCoverageFacts(cards) {
  ...
  const specialty = list.filter((c) => isSpecialtyCard(c)).length;
