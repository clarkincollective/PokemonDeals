...
export const ASSETS = Object.freeze({
  checklists: { label: "free set collection checklists", url: VERIFIED_LINKS.checklistExample, index: VERIFIED_LINKS.sets },
  cardIdGuide: { label: "guide to finding a card's set and collector number", url: VERIFIED_LINKS.cardIdGuide },
  referencePriceStudy: { label: "dated 30-day reference-price study", url: VERIFIED_LINKS.referencePriceStudy },
});
